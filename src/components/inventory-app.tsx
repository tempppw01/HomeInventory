...
function ItemCard({ item, onEdit, onConsume, onRemainingChange, onDelete, onQr, onAi, onCopy, onSelect, selected = false, compact = false }: { item: Item; onEdit: () => void; onConsume: () => void; onRemainingChange?: (remainingPercent: number) => void; onDelete?: () => void; onQr: () => void; onAi: () => void; onCopy?: () => void; onSelect?: () => void; selected?: boolean; compact?: boolean }) {
